...
public class GenSetTemplate extends PostfixTemplateWithExpressionSelector {

    public GenSetTemplate() {
        super("genset",
                "genset",
                "xxx.set...()",
    ...
    private String getSetsText(String objName, List<PsiField> paramentFields) {
        ...
        for (PsiField field : paramentFields) {
            ...
            builder.append(objName + ".set" + getFirstUpperCase(field.getName()) + "($VAR1$);\n");
        }
